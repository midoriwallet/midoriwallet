...
const CFBundleName = 'Midori Wallet';
...
async function run() {
  ...
  cordova('plugin add cordova-plugin-customurlscheme@5.0.2 --save --variable URL_SCHEME=midoriwallet');
  ...
  await addWatchApp('https://github.com/CoinSpace/cs-watchapp-ios.git#f59a021634138f22b4062114dbbe85ec6138c264');
